...
<head>
    ...
    <link rel="stylesheet" href="bootstrap/css/new.scss">
    ...
    <style type="text/css">
        .masthead {
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),
                url('https://ewm.swiss/application/files/7316/6686/8382/Shoppable_Content_EWM_SA_Digital_Agency_Geneva.jpg');
...
<body class="content" style="background-color:powderblue;">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="#"><img src="home.png" alt="" width="30" height=auto> Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="browse"><img src="browser-1@1x.png" alt="" width="30" height=auto> Browse  </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="checkout"><img src="clipboard-checklist-pen.png" alt="" width="30" height=auto> Checkout </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="order"><img src="status-icon-page_0.png" alt="" width="30" height=auto> Status </a>
                </li>
            </ul>
