	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item ">
                    <a class="nav-link" href="index"><img src="home.png" alt="" width="30" height=auto> Home </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="browse"><img src="browser-1@1x.png" alt="" width="30" height=auto> Browse  </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="checkout"><img src="clipboard-checklist-pen.png" alt="" width="30" height=auto> Checkout <span class="sr-only">(current)</span> </a>
                </li>
                <li class="nav-item">
